drop view key_fobs.v_export_runtimes;
...
WITH permissions AS (
                            ...
                            select distinct controller_ip, atm.start_time , end_time, start_date, end_date
                            FROM allow_times atm
--                            WHERE CURRENT_DATE >= atm.start_date
--                              AND CURRENT_DATE <= atm.end_date
							order by atm.start_time; 
