...
class ww_data_extractor:
    def __init__(self, the_uname, the_pass, the_url, interations=10):
    ...
    # def get_swipe_range(self, start_id):
    ...
    #             log_error(f"Error in get_swipe_range: {e}")
    #             return []   
    #         # new Swipes starts at newest swipe and works backwards
    #         # self.obj_db.insert_swipe_record(lst_swipes)
    #         swipes = []
    #         swipes.append(lst_swipes)
